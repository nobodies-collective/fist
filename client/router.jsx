    ...
    <BrowserRouter>
      ...
      <Switch>
        ...
        <Route path="/noinfo/strike">
          <RequireAuth {...eventInfo} authTest="isALead"><NoInfoDashboard period="strike" /></RequireAuth>
        </Route>
        <Route path="/noinfo">
          <RequireAuth {...eventInfo} authTest="isALead"><NoInfoDashboard period="event" /></RequireAuth>
        </Route>
        <Route>
          <NotFound />
        </Route>
